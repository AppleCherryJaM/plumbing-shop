...
const SearchToggle = () => {
  ...
  return (
    <div className={`${expanded ? styles.expanded :  styles.unexpanded} ${styles.searchWrapper}`}>
      <input
        type="text"
        placeholder="Пошук товарів..."
        className={styles.searchInput}
      />
      <button className={styles.toggleButton} onClick={toggleSearch} aria-label="Пошук">
